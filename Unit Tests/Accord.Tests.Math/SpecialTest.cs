...
namespace Accord.Tests.Math
{
    ...
    public class SpecialTest
    {
        ...
        public void Log1pTest()
        {
            ...
            ClassicAssert.IsTrue(double.IsNaN(Special.Log1p(double.NaN)));
            ClassicAssert.IsTrue(double.IsNaN(Special.Log1p(-32.0482175)));
            ClassicAssert.AreEqual(double.PositiveInfinity, Special.Log1p(double.PositiveInfinity));

            double b = System.Math.Log(1 - 7e-32);
            double c = Special.Log1p(7e-32);
            ClassicAssert.AreEqual(c, 7e-32);


            ClassicAssert.AreEqual(-0.2941782295312541, Special.Log1p(-0.254856327), precision);
            ClassicAssert.AreEqual(7.368050685564151, Special.Log1p(1583.542), precision);
            ClassicAssert.AreEqual(0.4633708685409921, Special.Log1p(0.5894227), precision);
            ClassicAssert.AreEqual(709.782712893384, Special.Log1p(double.MaxValue), precision);
            ClassicAssert.IsTrue(double.IsNaN(Special.Log1p(double.MinValue)));
        }
        ...
        public void FactorialTest()
        {
            ...
            ClassicAssert.AreEqual(expected, actual, 1e27);
        }
        ...
        public void LnFactorialTest()
        {
            ...
            ClassicAssert.AreEqual(expected, actual, 0.0000000001);
        ...
        public void BinomialTest2()
        {
            ...
            actual = Special.Binomial(n, k);
            ClassicAssert.AreEqual(expected, actual, 1e+16);
        }
        ...
        public void InverseErfTest()
        {
            for (int i = 0; i < 100; i++)
            {
                ...
                ClassicAssert.AreEqual(expected, actual, 1e-15);

                ClassicAssert.IsFalse(double.IsNaN(expected));
        ...
        public void LogSumTest()
        {
            ...
            e = 0.101;
            ClassicAssert.AreEqual(a, e, 1e-10);
            ...
            ClassicAssert.AreEqual(4.4408920985006262E-16, diff);
        }
