...
namespace Accord.Tests.Math
{
    ...
    public class LuDecompositionTest
    {
        ...
        public void InverseTestNaN()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                for (int j = 0; j < n; j++)
                {
                    ...
                    ClassicAssert.IsTrue(Matrix.IsEqual(target.Solve(I), target.Inverse()));

                    var target2 = new JaggedLuDecomposition(value.ToJagged());
                    ClassicAssert.IsTrue(Matrix.IsEqual(target2.Solve(I.ToJagged()), target2.Inverse()));
                }
            }
        }
        ...
        public void SolveTest1()
        {
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(value, target.Reverse()));

            var target2 = new JaggedLuDecomposition(value.ToJagged());
            actual = target2.Solve(rhs);
            ClassicAssert.IsTrue(Matrix.IsEqual(expected, actual, 1e-3));
            ClassicAssert.IsTrue(Matrix.IsEqual(value, target2.Reverse()));
        }
        ...
        public void InverseTest()
        {
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(expectedInverse, actualInverse, 0.001));
            ClassicAssert.IsTrue(Matrix.IsEqual(value, target.Reverse()));
        ...
        public void SolveTest()
        {
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(expected, new LuDecomposition(value).Solve(rhs), 1e-3));
            ClassicAssert.IsTrue(Matrix.IsEqual(expected, new JaggedLuDecomposition(value.ToJagged()).Solve(rhs.ToJagged()), 1e-3));
        }
        ...
        public void SolveTest3()
        {
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(expectedL, L, 1e-3));
            ClassicAssert.IsTrue(Matrix.IsEqual(expectedU, U, 1e-3));
        }
        ...
        public void SolveTest4()
        {
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(expected, target1.Solve(rhs), 1e-3));
            ClassicAssert.IsTrue(Matrix.IsEqual(expected, target2.Solve(rhs), 1e-3));
        }
        ...
        public void SolveTransposeTest()
        {
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(expected, new LuDecomposition(b, true).SolveTranspose(a), 1e-3));
            ClassicAssert.IsTrue(Matrix.IsEqual(expected, new JaggedLuDecomposition(b.ToJagged(), true).SolveTranspose(a.ToJagged()), 1e-3));
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(b, r, 1e-3));
            ClassicAssert.IsTrue(Matrix.IsEqual(b.Transpose(), target.Reverse(), 1e-3));
            ClassicAssert.IsTrue(Matrix.IsEqual(b.Transpose(), new JaggedLuDecomposition(b.ToJagged(), true).Reverse(), 1e-3));
        }
        ...
        public void LuDecompositionConstructorTest()
        {
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(matrix, reconstruction, 1e-4));
            ClassicAssert.IsTrue(Matrix.IsEqual(expectedL, L, 1e-4));
            ClassicAssert.IsTrue(Matrix.IsEqual(expectedU, U, 1e-4));
            ...
            ClassicAssert.IsTrue(Matrix.IsEqual(expectedL, L, 0.001));
            ClassicAssert.IsTrue(Matrix.IsEqual(expectedU, U, 0.001));
        }
        ...
        public void LogDeterminantTest()
        {
            ...
            ClassicAssert.AreEqual(0, lu.Determinant);
            ClassicAssert.AreEqual(-2224.8931093738875, lu.LogDeterminant, 1e-12);
            ClassicAssert.IsTrue(lu.Nonsingular);
        }
        ...
        public void DeterminantTest()
        {
            ...
            ClassicAssert.AreEqual(23, lu.Determinant);
            ClassicAssert.IsTrue(lu.Nonsingular);
        }
