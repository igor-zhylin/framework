    ...
    public class SparseTest
    {
        ...
        public void SetTest()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                if (i == 0)
                {
                    ClassicAssert.AreEqual(1, s[i]);
                    ClassicAssert.AreEqual(1, d[i]);
                }
                else if (i == 10)
                {
                    ClassicAssert.AreEqual(42, s[i]);
                    ClassicAssert.AreEqual(42, d[i]);
                }
                else if (i == 99)
                {
                    ClassicAssert.AreEqual(99, s[i]);
                    ClassicAssert.AreEqual(99, d[i]);
                }
                else
                {
                    ClassicAssert.AreEqual(0, s[i]);
                    ClassicAssert.AreEqual(0, d[i]);
                }
            }
        }
        ...
        public void ToStringTest()
        {
            ...
            actual = d.ToString();
            ClassicAssert.AreEqual("1:1 2:2 3:3 6:6", actual);

            v = new double[] { 0, 0, 2, 3, 0, 0, 6 };
            d = Sparse.FromDense(v);

            actual = d.ToString();
            ClassicAssert.AreEqual("3:2 4:3 7:6", actual);
        }
